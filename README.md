...
It is an optimized version of the WEAR dataset annotating pipeline by Bock et al. [1]. It lets you upload an excel file with the exercises and their duration logged in it (please refer to exercise.xlsl) which then helps generate labels for the recorded data.
